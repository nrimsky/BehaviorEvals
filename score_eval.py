...
def make_prompt(question_answer: Tuple[str, str], examples: List[Tuple[Tuple[str, str], int]], behavior_name: str, max_score: int):
    question, answer = question_answer
...
def evaluate(question_answers: List[Tuple[str, str]], examples: List[Tuple[Tuple[str, str], int]], behavior_name: str, max_score: int) -> List[str]:
    """
    ...
    for question_answer in question_answers:
        prompt = make_prompt(question_answer, examples, behavior_name, max_score)
        try:
...
def evaluate_json(filename: str, examples: List[Tuple[Tuple[str, str], int]], behavior_name: str, max_score: int) -> List[str]:
    """
    ...
    return evaluate(question_answers, examples, behavior_name, max_score)
...
if __name__ == "__main__":
    ...
    max_score = 100
    scores = evaluate(question_answers, examples, behavior_name, max_score)
    print(scores)